...
\autor{Leonardo Pereira Gonçalves \and Nome do Colega 2 \and Nome do Colega 3 \and Nome do Colega 4 \and Nome do Colega 5}
...
\begin{itemize}
    ...
    \item \textbf{Remoção de Colunas Irrelevantes:} A coluna \texttt{year} possui um valor constante (2025) para todos os registros e, portanto, não agrega valor preditivo ao modelo, podendo ser removida.
\end{itemize}
